...
public class Skynet2 extends AdvancedRobot {
	...
	public void onScannedRobot(ScannedRobotEvent e) {
		...
		if(e.getName() != null && activeTarget != null && e.getName() == activeTarget.getName() && e.getEnergy() < activeTarget.getEnergy()) { 
		      //TODO: Lag funksjonalitet som gj�r at roboten unnviker skudde
			moveDirection *= -1;
		...
		//sjekk om det er verdt � bytte active target
	...
	public void onRobotDeath(RobotDeathEvent e) {
		...
		//Hvis activeTarget var den som d�de, sett activetarget til null
	...
	public void doGun(AdvancedEnemyBot activeTarget) {
		...
		//St�r p� tvers av target s�nn at det er enklest � dodge
	...
	public void onHitByBullet(HitByBulletEvent e) {
		...
		//Velger � ikke snu, basert p� statistikk
		//moveDirection *= -1;
	}
